...
//YOU MPESA API KEYS
        $consumerKey = "9edem3KAhrncn9zu5vRHuZDhpHXrGAkM"; //Fill with your app Consumer Key
        $consumerSecret = "O5JNhdK4rshU96AU"; //Fill with your app Consumer Secret
//ACCESS TOKEN URL
        ...
        $BusinessShortCode = '4112023';
        $confirmationUrl = 'https://wifibillings.com/api/storeWebhookThree';
        $validationUrl = 'https://wifibillings.com/api/authenticate/Two';
        $curl = curl_init();
